...
public class GroupFieldTest {
    ...
    public void test1(){
        ...
        String result="ValidatedException(fieldName=null, msg=null, annotationName=null, value=null, valueIndex=null, violations=[MarsViolation(fieldName=a1, msg=a1不是对应的长度, annotationName=Length, value=1, valueIndex=0)])";
        String returnResult="";
